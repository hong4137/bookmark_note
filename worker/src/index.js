...
const PAGE_PROMPT = [
  ...
  '',
  '본문 페이지일 때 규칙:',
  '- 쪽번호, 각주 번호, 페이지마다 반복되는 머리말·꼬리말(장 제목, 책 제목),',
  '  출판사 정보는 빼세요. 페이지 가장자리에 작게 앉아 있는 것들입니다.',
  '- **본문 안의 소제목은 빼지 말고 문장으로 넣으세요.** "첫째, 일을 공개된 곳에서 하라",',
  '  "압박도 맥락이다" 처럼 굵게 한 줄로 앉은 제목도 글의 일부입니다.',
  '  빼 버리면 뒤에 오는 문단이 무슨 얘기인지 알 수 없게 됩니다.',
